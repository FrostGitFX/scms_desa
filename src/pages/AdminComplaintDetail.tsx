    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 mb-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3 text-sm text-gray-600 dark:text-gray-400">
                <span className="flex items-center">
                  ...
                  Pelapor: <strong className="ml-1 text-gray-900 dark:text-white">{complaint.users?.full_name}</strong>
                </span>
                <span className="flex items-center">
                ...
                {editingStatus ? (
                  <>
                    <select
                      ...
                      className="px-3 py-1 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none"
                      disabled={updating}
                    >
                    ...
                    <button
                      ...
                      disabled={updating}
                      className="p-2 bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-500 text-gray-700 dark:text-gray-200 rounded-lg transition"
                    >
                      <X className="h-4 w-4" />
                    </button>
                  </>
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="p-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 rounded-lg transition"
                      title="Edit Status"
                    >
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 dark:border-blue-400 p-4 mt-6">
