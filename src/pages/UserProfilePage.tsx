...
import { User, Mail, Phone, MapPin, CreditCard, ArrowLeft, Camera, Save, X, Calendar, Edit2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transition-colors duration-200">
          ...
          <div className="bg-gradient-to-r from-emerald-500 to-teal-500 px-8 py-12 text-center relative">
            {/* Avatar */}
