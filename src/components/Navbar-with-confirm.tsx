...
export default function Navbar({ currentPage, onNavigate }: NavbarProps) {
  ...
  return (
    <>
      <nav className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white shadow-lg border-b dark:border-gray-700 transition-colors duration-200">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-4 border-l dark:border-gray-700 pl-4">
                ...
                <button
                  ...
                  className="flex items-center space-x-2 px-3 py-2 bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 text-white rounded-lg transition-all duration-200"
                >
      ...
      <ConfirmDialog
        ...
        message="Apakah Anda yakin ingin keluar dari sistem? Anda harus login kembali untuk mengakses akun Anda."
